...
export type ShapeType = 'rect' | 'circle' | 'segment' | 'line' | 'triangle' | 'polygon';
...
export type ToolType = 'select' | 'rect' | 'circle' | 'segment' | 'line' | 'triangle' | 'polygon' | 'eraser' | 'trim' | 'point' | 'zoom';
